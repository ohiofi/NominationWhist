class Game {
  ...
  start() {
    ...
    const dealer = this.players[this.currentRoundNumber % this.players.length]; // Cycle through players to determine dealer for each round
    ...
    const round = new Round(this.numCardsPerPlayer, this.trumpSuit, dealer, this.players, this.numCardsPerPlayer);
    this.rounds.push(round);
    round.openBidModal(); // Start the bidding process for the round
    // players play cards from hands
    // scoring
    //}
